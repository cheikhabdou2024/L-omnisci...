...
const InitialUI = () => {
    return (
        <div className='h-full w-full flex items-center justify-center flex-col gap-5 text-white'>
            ...
            <h1 className='text-4xl text-center font-bold gradient-text'>Nous Vous Présentons Lomnisci... </h1>
            <p className='text-lg text-gray-400 text-center'>L'intelligence Artificiel Totalement Gratuit</p>
        </div>
    )
}
